...
public class Car extends Vehicle implements IType{

	private static final int MIN_NUMBER_OF_PASSENGERS = 1;
	private static final int MAX_NUMBER_OF_PASSENGERS = 5;
	
	public Car(int _id,int _capacity, String _sign, ArrayList<Person> _passengers, Person _driver, boolean _pauseDriving, boolean _passedPoliceTerminal, boolean _passedCustomsTerminal) {
